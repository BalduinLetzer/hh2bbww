...
from hbw.config.trigger_datasets import add_hbw_datasets, configure_hbw_datasets
from hbw.config.trigger_processes import add_hbw_processes
...
def add_config(
    ...
    cfg.x.external_files.update(DotDict.wrap({
        # files from TODO
        "lumi": {
            "golden": ("https://cms-service-dqmdc.web.cern.ch/CAF/certification/Collisions24/Cert_Collisions2024_378981_381417_Muon.json", "v1"),  # noqa
